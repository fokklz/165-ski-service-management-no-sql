...
namespace SkiServiceAPI.Services
{
    public class UserService : GenericService<User, UserResponse, UpdateUserRequest, CreateUserRequest>, IUserService
    {
        ...
        public async Task<TaskResult<object>> UnlockAsync(ObjectId id)
        {
        ...
        public override async Task<TaskResult<object>> UpdateAsync(ObjectId id, UpdateUserRequest entity)
        {
