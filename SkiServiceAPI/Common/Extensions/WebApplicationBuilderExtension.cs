...
using Serilog;
using SkiServiceAPI.Common.Serilog;
using SkiServiceAPI.Common.Swagger;
using StackExchange.Redis;

namespace SkiServiceAPI.Common.Extensions
{
    public static class WebApplicationBuilderExtension
    {
        ...
        public static WebApplicationBuilder SetupSerilog(this WebApplicationBuilder builder)
        {
            ...
            var redisName = redisConfig.GetValue("Name", "skiservice-api");
        ...
        public static WebApplicationBuilder SetupAuthorization(this WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                ...
                {
                    options.TokenValidationParameters = Program.GetTokenValidationParameters(builder.Configuration);
                });
